...
<Callout type="info">
	 Additionally, if the file is a `.cb*` file you may set this value with the use of [ComicInfo metadata](../../guides/metadata/comics#comicinfo) using the [format tag](../../guides/metadata/comics#format)
</Callout>
