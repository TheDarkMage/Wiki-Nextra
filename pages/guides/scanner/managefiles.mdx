...
<Callout type="info">
	 Additionally, if the file is a `.cb*` file you may set this value with the use of [ComicInfo metadata](https://wiki.kavitareader.com/guides/metadata/comics#comicinfo) using the [format tag](https://wiki.kavitareader.com/guides/metadata/comics#format)
</Callout>
