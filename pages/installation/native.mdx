...
<Callout type="warning">
  No one on the dev team owns a Mac. These instructions are suggested by our users. If you want to help contribute to this list click ["Help improve this page"](https://github.com/TheDarkMage/Wiki-Nextra/blob/main/pages/installation/native.mdx)!
</Callout>
